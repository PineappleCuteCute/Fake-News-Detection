...
def kiem_tra_text():
    ...
    with open("/Users/daomanh/Desktop/Fake-News-Detection/server/tokenizer.pkl", "rb") as file:
        tokenizer = pickle.load(file)
    new_sequences = tokenizer.texts_to_sequences(new_texts)
    new_padded_sequences = pad_sequences(new_sequences, maxlen=1000, padding='post')

    # Đường dẫn đến tệp tin mô hình .h5
    model_path = "/Users/daomanh/Desktop/Fake-News-Detection/server/FakeNewDetectionCNN16layers.h5"
